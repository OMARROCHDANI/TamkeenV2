        ...
        <section id="contact" className="py-32 bg-background">
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-24 items-start">
                    <div>
                        <span className="accent-text text-2xl text-accent block mb-6">Call To Action</span>
                        <h2 className="heading-luxury text-6xl md:text-8xl text-primary mb-12" style={{ lineHeight: '1.1' }}>
                            Build with <span className="text-cta">Discipline</span>.
                        </h2>
                        <p className="text-xl font-light text-primary mb-12">
                            If you are serious about long-term positioning —<br />Let’s begin.
                        </p>

                        <div className="space-y-8">
                            <div>
                                <h4 className="uppercase tracking-widest text-xs font-bold text-accent mb-2">Our Studio</h4>
                                <p className="text-xl font-light text-primary">Global Remote<br />Selective Partnerships Only</p>
                            </div>
                            <div>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                            ...
                            >
                                {formState === 'redirecting' ? 'Redirecting to WhatsApp...' : 'WhatsApp Inquiry'}
                            </button>
                        </form>
